                    ...
                    <form method="POST" action="{{ route('products.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="prod_name" id="searchProdName">
                            </div>
                        </div>
                        <!-- Second Row -->
                        <div class="row">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control" name="purchased_date" id="searchPurchasedDate">
                        </div>
                    </div>
                    <!-- Fourth Row -->
                    <div class="row">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div>
                ...
                <button class="btn btn-primary mr-2" data-toggle="modal" data-target="#addproductModal">Add product</button>
